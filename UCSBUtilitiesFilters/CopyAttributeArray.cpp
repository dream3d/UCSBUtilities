...
void CopyAttributeArray::setupFilterParameters()
{
...

  {
    ...
    parameters.push_back(DataArraySelectionFilterParameter::New("Attribute Array to Copy", "SelectedArrayPath", getSelectedArrayPath(), FilterParameter::RequiredArray, SIMPL_BIND_SETTER(CopyAttributeArray, this, SelectedArrayPath), SIMPL_BIND_GETTER(CopyAttributeArray, this, SelectedArrayPath), req));
  }
